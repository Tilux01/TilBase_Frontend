            ...
            <DashboardLayout>
                ...
                {isModalOpen && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
                        <div className="bg-surface-container p-6 rounded-xl w-[400px] shadow-2xl border border-black/5 dark:border-white/5">
                            <h3 className="text-xl font-bold mb-4 text-on-surface">Add IP Address</h3>
                            <form onSubmit={addRule}>
                                <input className="w-full mb-3 px-4 py-2.5 bg-surface-container-highest border border-black/5 dark:border-white/5 rounded-lg outline-none focus:ring-2 focus:ring-primary text-sm text-on-surface technical-mono" placeholder="IP Address (e.g. 192.168.1.0/24)" value={newIp} onChange={e=>setNewIp(e.target.value)} required />
                                {newIp === '0.0.0.0/0' && (
                                ...
                                <input className="w-full mb-6 px-4 py-2.5 bg-surface-container-highest border border-black/5 dark:border-white/5 rounded-lg outline-none focus:ring-2 focus:ring-primary text-sm text-on-surface" placeholder="Description" value={newDesc} onChange={e=>setNewDesc(e.target.value)} required />
                ...
                <div className="flex gap-2 mb-8 bg-surface-container-highest p-1 rounded-xl inline-flex">
                    <button className="px-6 py-2 bg-surface-container shadow-sm text-primary font-semibold rounded-lg text-sm transition-all">IP Access List</button>
                ...
                <div className="grid grid-cols-12 gap-6">
                    <div className="col-span-12 md:col-span-4 h-full">
                        <div className="bg-surface-container p-6 rounded-xl border border-black/5 dark:border-white/5 shadow-sm flex flex-col justify-between h-full relative overflow-hidden group">
                    ...
                    <div className="col-span-12 md:col-span-8">
                        <div className="bg-surface-container-high p-8 rounded-xl flex flex-col md:flex-row gap-8 items-center border border-white/40 shadow-inner">
                            <div className="flex-1 space-y-4">
                                ...
                                <div className="flex flex-wrap gap-4 pt-2">
                                    <div className="flex-1 min-w-[200px]">
                                        ...
                                        <select className="w-full bg-surface-container-highest border-black/5 dark:border-white/5 rounded-lg py-2.5 px-4 text-sm focus:ring-2 focus:ring-primary outline-none appearance-none">
                                    ...
                                    <div className="flex-1 min-w-[200px]">
                                        ...
                                        <input className="technical-mono w-full bg-surface-container-highest border-black/5 dark:border-white/5 rounded-lg py-2.5 px-4 text-sm focus:ring-2 focus:ring-primary outline-none" placeholder="vpc-0a1b2c3d4e" type="text" />
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody className="divide-y divide-surface-container-low">
                                        {filteredRules?.length === 0 ? (
                                            ...
                                            filteredRules?.slice(0, 15).map((rule) => (
                                                <tr key={rule.id} className="hover:bg-surface-container border border-black/5 dark:border-white/5 transition-colors">
                                                    ...
                                                    <td className="px-6 py-5">
                                                        <div className="flex justify-center">
                                                            {rule.IP_Address === '0.0.0.0/0' ? (
                                                                ...
                                                                <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-surface-container border border-black/5 dark:border-white/5 text-on-primary-fixed-variant text-xs font-bold">
