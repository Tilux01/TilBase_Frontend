        ...
        <div className="flex flex-col h-screen w-full bg-background text-on-surface font-sans overflow-hidden">
            ...
            <header className="flex-none bg-surface-container-lowest border-b border-outline-variant/30 px-6 py-4 flex items-center justify-between z-10 shadow-sm">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="bg-primary/10 text-primary px-2 py-0.5 rounded text-xs font-bold tracking-wider ml-2">GRAPH ENGINE</span>
                    </div>
                </div>
            </header>

            <div className="flex-1 flex h-full w-full bg-surface-container-lowest text-on-surface overflow-hidden relative" ref={wrapperRef}>
            ...
            <div className="absolute top-4 left-4 z-10 flex space-x-3">
                <button 
                    ...
                    className="flex items-center space-x-2 px-4 py-2 bg-primary/90 text-primary-content hover:bg-primary rounded-xl shadow-lg backdrop-blur-md transition-all font-medium text-sm border border-primary/20"
                >
                    <Plus size={16} /> <span>Add Node</span>
                </button>
                <button 
                    onClick={() => { setIsAddEdgeOpen(true); setIsAddNodeOpen(false); }}
                    className="flex items-center space-x-2 px-4 py-2 bg-surface-container-high/80 text-on-surface hover:bg-surface-container-highest rounded-xl shadow-lg backdrop-blur-md transition-all font-medium text-sm border border-outline-variant/30"
                >
                    <Zap size={16} /> <span>Add Edge</span>
                </button>
                <div className="flex items-center space-x-2 px-3 py-1.5 bg-surface-container-high/80 text-on-surface rounded-xl shadow-lg backdrop-blur-md transition-all font-medium text-sm border border-outline-variant/30 ml-4">
            ...
            <div className="absolute top-4 right-4 z-10 flex space-x-3">
                <div className="px-4 py-2 bg-surface-container/60 backdrop-blur-xl rounded-xl border border-outline-variant/20 text-xs font-mono text-outline">
            ...
            {selectedNode && (
                <div className="absolute top-16 right-4 w-80 bg-surface-container/80 backdrop-blur-2xl border border-outline-variant/30 rounded-2xl shadow-2xl p-5 z-20 animate-in slide-in-from-right fade-in">
                    ...
                    {isEditingNode ? (
                        <div className="bg-[#0f0f11] rounded-xl p-3 mb-4 overflow-hidden border border-primary/40 shadow-inner">
                            <textarea 
                                value={editNodeProps} 
                        ...
                        <div className="bg-[#0f0f11] rounded-xl p-3 mb-4 overflow-hidden border border-outline-variant/10 shadow-inner group relative">
                            ...
                            <button 
                                ...
                                className="absolute top-2 right-2 bg-surface-container p-1 rounded opacity-0 group-hover:opacity-100 transition-opacity"
                            >
            ...
            {selectedEdge && (
                <div className="absolute top-16 right-4 w-80 bg-surface-container/80 backdrop-blur-2xl border border-outline-variant/30 rounded-2xl shadow-2xl p-5 z-20 animate-in slide-in-from-right fade-in">
                    ...
                    <div className="flex items-center justify-between text-xs font-mono bg-surface-container-lowest p-2 rounded-lg mb-4 border border-outline-variant/20">
                    ...
                    <div className="text-sm mb-4">
                        ...
                        {isEditingEdge ? (
                            <input type="number" step="0.1" value={editEdgeWeight} onChange={e => setEditEdgeWeight(e.target.value)} className="w-16 bg-surface-container-highest px-2 py-0.5 rounded outline-none ml-2 font-mono" />
                        ) : (
            ...
            {isAddNodeOpen && (
                <div className="absolute inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
                    <div className="bg-surface-container rounded-2xl p-6 w-[400px] border border-outline-variant/20 shadow-2xl animate-in zoom-in-95">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input 
                                    ...
                                    className="w-full bg-surface-container-lowest border border-outline-variant/30 rounded-lg px-3 py-2 text-sm focus:border-primary outline-none focus:ring-1 ring-primary/50"
                            ...
                            <div>
                                ...
                                <textarea 
                                    ...
                                    className="w-full bg-surface-container-lowest border border-outline-variant/30 rounded-lg px-3 py-2 text-sm font-mono h-32 focus:border-primary outline-none focus:ring-1 ring-primary/50"
                                    placeholder="{}"
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <select 
                                    ...
                                    className="w-full bg-surface-container-lowest border border-outline-variant/30 rounded-lg px-3 py-2 text-sm focus:border-primary outline-none"
                                >
