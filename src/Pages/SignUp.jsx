        ...
        <div className="h-screen w-full flex bg-[#0B101A] text-white selection:bg-[#16A34A] overflow-hidden font-sans">
            ...
            <div className="hidden lg:flex w-1/2 relative flex-col justify-between p-12 border-r border-[#222834] overflow-hidden bg-[#05080f]">
                ...
                <div className="relative z-10 max-w-md">
                    <h2 className="text-4xl md:text-5xl font-serif text-white mb-6 leading-tight">
                        Start building at the <span className="text-[#39e03d] italic">edge.</span>
                    </h2>
                    <p className="text-[#8c93a1] text-lg leading-relaxed">
                        Join thousands of developers curating the next generation of databases and AI ChatBots seamlessly.
                    </p>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative overflow-y-auto">
                ...
                >
                    ...
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold mb-2 text-white tracking-tight">Create an account</h1>
                        <p className="text-[#8c93a1]">Enter your details below to get started</p>
                    </div>
                    ...
                    <div className="relative flex items-center mb-8">
                        ...
                        <span className="flex-shrink-0 mx-4 text-[#64748B] text-xs tracking-widest uppercase font-semibold">or continue with email</span>
                        <div className="flex-grow border-t border-[#222834]"></div>
                    </div>
                    ...
                    <div className="space-y-5">
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <User size={18} className="text-[#64748B] group-focus-within:text-[#39e03d] transition-colors" />
                                </div>
                                <input value={userName} onChange={(e) => setUserName(e.target.value)} type="text" placeholder="johndoe" className="w-full bg-[#151922] border border-[#222834] rounded-xl py-3 pl-11 pr-4 text-white placeholder-[#475569] focus:outline-none focus:border-[#16A34A] focus:ring-1 focus:ring-[#16A34A] hover:border-[#334155] transition-all shadow-sm" />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="pt-2">
                                <div className="flex justify-between items-center mb-2">
                                    <span className="text-[10px] text-[#64748B] uppercase tracking-widest font-bold">Security Level</span>
                                    <span className="text-[10px] font-bold text-[#39e03d] uppercase tracking-widest">
                                ...
                                <div className="flex gap-1 h-1.5">
                                    {[1, 2, 3, 4].map((level) => (
                                        <div key={level} className={`flex-1 rounded-full transition-all duration-300 ${passwordStrength >= level ? 'bg-[#39e03d] shadow-[0_0_10px_rgba(57,224,61,0.5)]' : 'bg-[#222834]'}`}></div>
                                    ))}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3 pt-4 pb-6">
                            <div className="flex items-center h-5 mt-0.5 relative group">
                                <input checked={acceptPolicy} onChange={(e) => setAcceptPolicy(e.target.checked)} type="checkbox" className="w-5 h-5 rounded border-[#222834] bg-[#151922] text-[#16A34A] focus:ring-[#16A34A] focus:ring-offset-0 cursor-pointer appearance-none checked:bg-[#16A34A] transition-colors" />
                                {acceptPolicy && (
                                   <span className="material-symbols-outlined absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[#050505] text-[14px] pointer-events-none font-bold">check</span>
                                )}
                            </div>
                            <p className="text-sm text-[#8c93a1] leading-relaxed">
                                I agree to the <Link to="/terms" className="text-white hover:text-[#39e03d] transition-colors font-medium">Terms of Service</Link> and <Link to="/privacy" className="text-white hover:text-[#39e03d] transition-colors font-medium">Privacy Policy</Link>.
                            </p>
                        </div>
                        ...
                        <button 
                            onClick={submitCred} 
                            disabled={processing}
                            className="w-full bg-[#16A34A] text-[#050505] py-4 rounded-xl font-bold text-base hover:bg-[#39e03d] hover:shadow-[0_0_20px_rgba(22,163,74,0.4)] hover:-translate-y-0.5 active:translate-y-0 transition-all disabled:opacity-50 disabled:pointer-events-none flex justify-center items-center h-14"
                        >
                            {processing ? <Loader2 size={22} className="animate-spin text-[#050505]" /> : "Create Account"}
                        </button>
                    </div>

                    <div className="mt-8 text-center border-t border-[#222834] pt-8">
                        <p className="text-[#8c93a1]">
                            Already have an account? <a onClick={() => navigate('/signin')} className="text-white font-semibold hover:text-[#39e03d] transition-colors cursor-pointer ml-1">Sign In</a>
                        </p>
                    </div>
                </motion.div>
            </div>
