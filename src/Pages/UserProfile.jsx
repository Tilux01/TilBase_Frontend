        ...
        <div>
            <header className="fixed top-0 z-40 w-full bg-[#f7faf6] dark:bg-zinc-950 flex justify-between items-center px-6 py-3 border-b border-[#bec9c1]/30 font-['Inter'] font-medium tracking-tight">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="h-8 w-8 rounded-full bg-primary-container flex items-center justify-center text-white text-xs font-bold border border-outline-variant/20">
                        JD
                    </div>
                </div>
            </header>
            ...
            <main className="ml-64 pt-16 min-h-screen bg-background">
                <div className="w-full p-8 md:p-12">
                    ...
                    <div className="grid grid-cols-12 gap-6 items-start">
                        <section className="col-span-12 lg:col-span-8 bg-surface-container-lowest rounded-xl p-8 shadow-[0px_12px_32px_-4px_rgba(17,24,39,0.06)] border border-outline-variant/10">
                            ...
                            <div className="flex flex-col md:flex-row gap-10">
                                <div className="flex-shrink-0 group relative">
                                    <div className="w-32 h-32 rounded-lg bg-surface-container-high flex items-center justify-center text-3xl font-bold text-primary-container border-2 border-dashed border-outline-variant transition-all hover:border-primary cursor-pointer overflow-hidden">
                                ...
                                <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-1.5">
                                        ...
                                        <input className="w-full bg-surface-container-low border-0 rounded-md focus:ring-2 focus:ring-primary text-on-surface py-2.5 px-4 transition-all" type="text" value="John Doe" />
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-xs font-bold text-on-surface-variant uppercase tracking-wider">Job Title</label>
                                        <input className="w-full bg-surface-container-low border-0 rounded-md focus:ring-2 focus:ring-primary text-on-surface py-2.5 px-4 transition-all" type="text" value="Lead Database Architect" />
                                    </div>
                                    <div className="space-y-1.5 md:col-span-2">
                                        <label className="text-xs font-bold text-on-surface-variant uppercase tracking-wider">Work Email</label>
                                        <div className="relative">
                                            <input className="w-full bg-surface-container-low border-0 rounded-md focus:ring-2 focus:ring-primary text-on-surface py-2.5 px-4 transition-all technical-data" type="email" value="john@tilbase.com" />
                                ...
                                <div className="space-y-5">
                                    <div>
                                        ...
                                        <div className="grid grid-cols-3 gap-2">
                                            <button className="py-2 text-[11px] font-bold bg-white text-primary border-2 border-primary rounded-md">Light</button>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-center gap-2 bg-surface-container-low p-2 rounded-md border border-outline-variant/20">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <input className="w-full bg-surface-container-low border-0 rounded-md focus:ring-2 focus:ring-tertiary text-on-surface py-2.5 px-4 transition-all" placeholder="••••••••••••" type="password" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[11px] font-bold text-on-surface-variant uppercase tracking-widest">New Password</label>
                                            <input className="w-full bg-surface-container-low border-0 rounded-md focus:ring-2 focus:ring-tertiary text-on-surface py-2.5 px-4 transition-all" placeholder="Min 12 characters" type="password" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[11px] font-bold text-on-surface-variant uppercase tracking-widest">Confirm New Password</label>
                                            <input className="w-full bg-surface-container-low border-0 rounded-md focus:ring-2 focus:ring-tertiary text-on-surface py-2.5 px-4 transition-all" type="password" />
                                        </div>
                                ...
                                <div className="space-y-8">
                                    <div className="bg-surface-container-low p-5 rounded-lg border border-outline-variant/20">
                                        ...
                                        <button className="w-full py-2 border-2 border-primary text-primary font-bold rounded-md hover:bg-primary/5 transition-colors text-sm">Manage 2FA Settings</button>
                                    </div>
                                    <div className="space-y-4">
                                        <h3 className="text-[11px] font-bold text-on-surface-variant uppercase tracking-widest">Active Ledger Access</h3>
                                        <div className="space-y-3">
                                            <div className="flex items-center gap-4 p-3 bg-white border border-outline-variant/10 rounded-md">
